...
const ar = {
  ...
  signHint: 'أدِّ الإشارة ثم أنزل يديك قليلًا قبل الإشارة التالية. للتهجئة، اثبت على كل حرف لحظة.',
...
const en: Dict = {
  ...
  signHint: 'Sign, then lower your hands briefly before the next sign. To fingerspell, hold each letter for a moment.',
